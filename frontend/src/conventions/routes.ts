...
export const Route = {
  ...
  AdminUsage: '/admin/usage',             // FE-19 aggregate usage report (HP-15)
...
export const ROUTE_META: Record<Route, RouteMeta> = {
  ...
  [Route.AdminUsage]: { layout: LayoutMode.Admin, requiresAuth: true, adminOnly: true },          // FE-19 aggregate usage
